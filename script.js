...
function agregarUsuario() {
  ...
  let identificacion = document.getElementById("form1-usarios-identificacion").value;
  let direccion = document.getElementById("form1-usarios-direccion").value;
  let telefono = document.getElementById("form1-usarios-telefono").value;
  let whatsap = document.getElementById("form1-usarios-whatsapp").value;
  let correo = document.getElementById("form1-usarios-correo").value;
  let estado = document.getElementById("form1-usarios-estado").value;
